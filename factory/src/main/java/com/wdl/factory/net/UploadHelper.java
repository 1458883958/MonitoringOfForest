...
public class UploadHelper {
    ...
    //上传仓库名
    private static final String BUCKET_NAME = "moocim-a";

    private static OSS getOSSClient() {
        OSSCredentialProvider credentialProvider =
                new OSSPlainTextAKSKCredentialProvider("LTAIQAXLZM1mbK7z"
                        , "8uwJhJ1hnnzVmT5LtCg5SzRWicb2C5");
        return new OSSClient(Factory.application(), ENDPOINT, credentialProvider);
    }
